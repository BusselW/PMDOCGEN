// =====================
// Applicatie Configuratie Module
// =====================
...
export const categoryOptions = [
    { id: 'verkeersborden', name: 'Verkeersborden' },
    { id: 'snelheid', name: 'Snelheid' },
    { id: 'zvZichtPlicht', name: 'ZV Zicht & Plicht' },
    { id: 'rijgedrag', name: 'Rijgedrag' },
    { id: 'parkeren', name: 'Parkeren' },
    { id: 'zvFlits', name: 'ZV Flits' }
];
...
export const initialFormData = {
    ...
    aanhoudingBesluitGenomen: false, aanhouding: '', tijdigheidBeroepType: 'tijdigIngediend',
    ...
    afspraken: '', afloopZaakType: 'schriftelijkeUitspraak', mondelingUitspraakTekst: '',
...
export const config = {
    ...
    dropdownOptions: {
        ...
        tijdigheidBeroepOpties: [{ value: 'tijdigIngediend', label: 'Het beroepschrift is tijdig ingediend' }, { value: 'teLaatIngediend', label: 'Het beroepschrift is te laat ingediend' }, { value: 'termijnOverschreden', label: 'De termijn is overschreden met meer dan 14 dagen' }],
