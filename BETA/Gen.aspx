...
<head>
    ...
    <script src="https://som.org.om.local/sites/MulderT/CustomPW/UPP/PMDOC/react-production.js"></script>
    <script src="https://som.org.om.local/sites/MulderT/CustomPW/UPP/PMDOC/react.dom-production.js"></script>
    ...
    <script type="module">
        ...
        const App = () => {
            ...
            const renderStep1 = () => {
                ...
                return h(Fragment, null,
                    h('h3', { className: 'stap-titel' }, h('span', { dangerouslySetInnerHTML: { __html: config.steps.hoorverslag[0].icon } }), ' Stap 1: Aanwezigheid'),
